    ...
    <header>
        ...
        <section class="F1">
            ...
            <div class="itens-wrap" style="flex-direction: column;">
                <div class="container-content">
                    <h2 class="text-center" style="justify-content: left;"><?php echo $infoSite['F1_titulo1']; ?></h2>
                    <p class="p-align"><?php echo $infoSite['F1_descricao1']; ?></p>
                </div>
                ...
                ?>
                    ...
                    <div class="container-content" style="margin-top: 30px;">
                        ...
                        <h2 style="margin:30px 0; color:rgb(167 183 204); font-size: 35px;"><?php echo $infoSite['F1_titulo'.$i]; ?></h2>
                        <?php echo $infoSite['F1_descricao'.$i]; ?>
        ...
        <section class="transfer-form">
            ...
            <div class="form_title">
                <h3>RESERVE SEU PACOTE TURÍSTICO</h3>
            </div>
            ...
            <form target="_blank" action="https://formsubmit.co/atendimento@checkpointtours.com.br" method="POST">
                ...
                <div>
                    ...
                    <select name="veiculo" id="option" class="form-select" form="carform">
                        <?php
                            for($i = 2; $i <= 4; $i++){
                        ?>
                            <option id="option" value="<?php echo $infoSite['F1_titulo'.$i]; ?>"><?php echo $infoSite['F1_titulo'.$i]; ?></option>
                        <?php } ?>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="number" min="1" id="qtd" required name="numero de pessoas" placeholder="5" class="form-select">
                </div>
                ...
                <div>
                    ...
                    <input type="number" id="tel" required name="tel" placeholder="Tel" class="form-select">
                </div>
