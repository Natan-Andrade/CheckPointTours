...
?>
    ...
    <header>
        <div class="container">
            ...
            <a href="<?php echo INCLUDE_PATH; ?>CE"><img style="width: 70%;" class="logo" src="<?php echo INCLUDE_PATH; ?>/logos/logo.png"></a>
                ...
                <div class="nav-links">
                    ...
                    <ul>
                        <li class="nav-link" style="--i: .6s">
                            <a href="<?php echo INCLUDE_PATH; ?>CE">Home</a>
                        </li>

                        <li class="nav-link" style="--i: .6s">
                            <a href="<?php echo INCLUDE_PATH; ?>CE">Fortaleza<i class="fas fa-caret-down"></i></a>
