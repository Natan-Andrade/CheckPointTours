        ...
        <div class="container">
            <input type="checkbox" name="" id="check">
                ...
                <div class="logo-container">
                    <a href="<?php echo INCLUDE_PATH; ?>oquefazernatal"><img style="width: 70%;" class="logo" src="<?php echo INCLUDE_PATH; ?>/logos/logo.png"></a>
                </div>
            <div class="nav-btn">
                <div class="nav-links">
                    ...
                    <ul>
                        <li class="nav-link" style="--i: .6s">
                            <a href="<?php echo INCLUDE_PATH; ?>oquefazernatal">Home</a>
                        </li>

                        <li class="nav-link" style="--i: .6s">
                            <a href="<?php echo INCLUDE_PATH; ?>oquefazernatal"><?php echo $cidade; ?><i class="fas fa-caret-down"></i></a>
                            ...
                            <div class="dropdown">
                                ...
                                <ul>
                                    <li class="dropdown-link">
                                        <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-natal-">Tour De Meio Dia</a>
                                    </li>
        
                                    <li class="dropdown-link">
                                         <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-natal-">Tour de Dia Inteiro</a>
                                    </li>

                                    <li class="dropdown-link">
                                         <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-natal-">Cidade de Natal à noite</a>
                                    </li>
                                    
                                    <li class="dropdown-link">
                                         <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-natal-">Passeio de Buggy</a>
                                    </li>

                                    <li class="dropdown-link">
                                         <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-natal-">Praias</a>
                                    </li>

                                    <li class="dropdown-link">
                                         <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-natal-">Atrativos turísticos</a>
                                    </li>
                                    ...
                                    <li class="dropdown-link">
                                         <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-natal-">Serviços</a>
                                    </li>
                                </ul>
                            </div>
