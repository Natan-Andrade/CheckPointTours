...
<body>
    ...
    <section class="article-container">
        <section id="sobrenos">
            ...
            <p>
                Somos uma agência de turismo especializada na operação de tours e serviços receptivos. Nossa empresa atua no mercado há 20 anos. Para nós, seu conforto e satisfação são os mais importantes.

                Gostaríamos de apresentar-lhe alguns dos principais produtos que temos a oferecer:

                Além do serviço receptivo em São Paulo, temos também tours guiados para as principais capitais e cidades brasileiras, tais como Rio de Janeiro, Fortaleza, Foz do Iguaçu, entre outras. Todos nossos tours são acompanhados por guias altamente qualificados e profissionais treinados na área de turismo e fluentes em Inglês, Espanhol e Português.

                Além disso, em todos os tours que oferecemos, nossos clientes têm à disposição os seguintes itens:

                Frota de carros de turismo e ônibus confortáveis, muito sofisticados e com ar condicionado, tais como vans e microônibus, de forma a atender suas necessidades;

                Assistência 24 horas em aeroportos, incluindo recepção, traslados, check-in e check-outs;

                Congressos, feiras, excursões e assistência em eventos em geral;

                Programas especiais de entretenimento, tais como visitas a shoppings, museus, parques, praias, bares, boates, danceterias etc.

                Visite o restante do nosso site e, se necessitar de mais alguma informação, não hesite em nos contatar.
            </p>
        </section>
        ...
        <section id="nossaequipe">
            ...
            <div class="membros">
                <img src="<?php echo INCLUDE_PATH; ?>images\renata_foto.png" alt="Renata"> 
                <h3>
                    <ul>
                        <li>
                            Renata dos Santos
                        ...
                        <li>
                            E-mail: financeiro@checkpointtours.com.br
                        </li>
                    </ul>
                </h3>
            </div>
            ...
            <div class="membros">
                <img src="<?php echo INCLUDE_PATH; ?>images\anapaula_foto.png" alt="Ana Paula"> 
                <h3>
                    <ul>
                        <li>
                            Ana Paula
                        ...
                        <li>
                            E-mail: receptive@checkpointtours.com.br
                        </li>
                    </ul>
                </h3>
            </div>
            ...
            <div class="membros">
                <img src="<?php echo INCLUDE_PATH; ?>images\brenda_foto.png" alt="Brenda"> 
                <h3>
                    <ul>
                        <li>
                            Brenda
                        ...
                        <li>
                            E-mail: checkpoint@checkpointtours.com.br
                        </li>
                    </ul>
                </h3>
            </div>
            ...
            <div class="membros">
                <img src="<?php echo INCLUDE_PATH; ?>images\valquiria_foto.png" alt="Valquiria Maraes"> 
                <h3>
                    <ul>
                        <li>
                            Valquiria Maraes
                        ...
                        <li>
                            E-mail: atendimento@checkpointtours.com.br
                        </li>
                    </ul>
                </h3>
            </div>
