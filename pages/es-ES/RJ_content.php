                ...
                <div class="margin-items">
                    <div class="sideitem" style="background-image: url(<?php echo $infoSite['RJ_bg1']; ?>);">
                        <div class="row-content">
                            ...
                            <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-rio-de-janeiro" target="_blank">Ver más >></a>
                    ...
                    <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-rio-de-janeiro" class="sideitem-2" style="background-image: url(<?php echo INCLUDE_PATH ?>pages/assets/banners/rjbg-esp.png);">
                    </a><!--sideitem-->
        ...
        <div class="double-grid">
            ...
            <div class="grid-main">
                ...
                <section class="section2">
                    <a href="es-ES/transfers" class="buttonClass">ver todas las transferencias</a>
                </section>
