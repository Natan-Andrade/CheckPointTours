                ...
                <div class="margin-items">
                    <div class="sideitem" style="background-image: url(<?php echo $infoSite['RN_bg1']; ?>);">
                        <div class="row-content">
                            ...
                            <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-natal-" target="_blank">Ver más >></a>
                    ...
                    <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-natal-" class="sideitem-2" style="background-image: url(<?php echo INCLUDE_PATH ?>pages/assets/banners/natalbg-esp.png);">
