...
?>
    ...
    <header>
        <div class="container">
            ...
            <a href="<?php echo INCLUDE_PATH; ?>es-ES/oquefazerfozdoiguacu"><img style="width: 70%;" class="logo" src="<?php echo INCLUDE_PATH; ?>./logos/logo.png"></a>
                ...
                <div class="nav-links">
                    ...
                    <ul>
                        <li class="nav-link" style="--i: .6s">
                            <a href="<?php echo INCLUDE_PATH; ?>es-ES/oquefazerfozdoiguacu">Home</a>
                        </li>

                        <li class="nav-link" style="--i: .6s">
                            <a href="<?php echo INCLUDE_PATH; ?>es-ES/oquefazerfozdoiguacu"><?php echo $cidade; ?><i class="fas fa-caret-down"></i></a>
                            ...
                            <div class="dropdown">
                                ...
                                <ul>
                                    ...
                                    <li class="dropdown-link">
                                        <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-foz-do-iguacu">Tour De Medio dia</a>
                                    </li>
        
                                    <li class="dropdown-link">
                                         <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-foz-do-iguacu">Tour de Día completo</a>
                                    </li>

                                    <li class="dropdown-link">
                                        <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-foz-do-iguacu">Parque de pájaros</a>
                                    </li>

                                    <li class="dropdown-link">
                                        <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-foz-do-iguacu">Atracciones turísticas</a>
                                    </li>
