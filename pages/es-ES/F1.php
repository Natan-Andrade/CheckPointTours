    ...
    <header>
                    ...
                    <ul>
                        ...
                        <a><p><i class="fa-solid fa-language"></i></p><i class="fas fa-caret-down"></i></a>
                            ...
                            <div class="dropdown">
                                <ul>
                                    <li class="dropdown-link">
                                        <a href="<?php echo INCLUDE_PATH; ?>F1"><img src="<?php echo INCLUDE_PATH; ?>\pages\assets\icons\brasil.png" alt="pt-BR"><p>Português</p></a><!-- pt-BR -->
                                    </li>

                                    <li class="dropdown-link">
                                        <a href="<?php echo INCLUDE_PATH; ?>en-US/F1"><img src="<?php echo INCLUDE_PATH; ?>\pages\assets\icons\estados-unidos.png" alt="en-US"><p>English</p></a><!-- eng-US -->
                                    </li>
        
                                    <li class="dropdown-link">
                                        <a href="<?php echo INCLUDE_PATH; ?>es-ES/F1"><img src="<?php echo INCLUDE_PATH; ?>\pages\assets\icons\espanha.png" alt="es-ES"><p>Espanõl</p></a><!-- en-US -->
                                    </li>
                                </ul>
                            </div>
                        </li>
        ...
        <section class="F1">
            ...
            <div class="itens-wrap" style="flex-direction: column;">
                <div class="container-content">
                    <h2 class="text-center" style="justify-content: left;"><?php echo $infoSite['esp_F1_titulo1']; ?></h2>
                    <p class="p-align"><?php echo $infoSite['esp_F1_descricao1']; ?></p>
                </div>
                ...
                ?>
                    ...
                    <div class="container-content" style="margin-top: 30px;">
                        ...
                        <h2 style="margin:30px 0; color:rgb(167 183 204); font-size: 35px;"><?php echo $infoSite['esp_F1_titulo'.$i]; ?></h2>
                        <?php echo $infoSite['esp_F1_descricao'.$i]; ?>
        ...
        <section class="transfer-form">
            ...
            <div class="form_title">
                <h3>RESERVA TU PAQUETE TURÍSTICO</h3>
            </div>
            ...
            <form target="_blank" action="https://formsubmit.co/atendimento@checkpointtours.com.br" method="POST">
                ...
                <div>
                    <label for="festa">Seleccione el Paquete:</label>
                    </br>
                    <select name="veiculo" id="option" class="form-select" form="carform">
                        <?php
                            for($i = 2; $i <= 4; $i++){
                        ?>
                            <option id="option" value="<?php echo $infoSite['esp_F1_titulo'.$i]; ?>"><?php echo $infoSite['F1_titulo'.$i]; ?></option>
                        <?php } ?>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="number" min="1" id="qtd" required name="numero de pessoas" class="form-select">
                </div>
                ...
                <a class="button_reservar" href="https://wa.me/551127911316?text="
                    ...
                    <div class="inside_button">
                        Reservar por WhatsApp <i class="fa-brands fa-whatsapp"></i>
                    </div>
                </a>
            </form>
        </section>
