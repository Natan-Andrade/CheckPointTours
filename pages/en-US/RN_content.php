                ...
                <div class="margin-items">
                    <div class="sideitem" style="background-image: url(<?php echo $infoSite['RN_bg1']; ?>);">
                        <div class="row-content">
                            ...
                            <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-natal-" target="_blank">See more >></a>
                    ...
                    <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-natal-" class="sideitem-2" style="background-image: url(<?php echo INCLUDE_PATH ?>pages/assets/banners/natalbg-eng.png);">
        ...
        <div class="double-grid">
            ...
            <div class="grid-main">
                ...
                <section class="section2">
                    <a href="<?php echo INCLUDE_PATH; ?>en-US/transters" class="buttonClass">All transfers</a>
                </section>
