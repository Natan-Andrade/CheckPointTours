...
?>
    ...
    <header>
        <div class="container">
            ...
            <a href="<?php echo INCLUDE_PATH; ?>en-US/oquefazernatal"><img style="width: 70%;" class="logo" src="<?php echo INCLUDE_PATH; ?>/logos/logo.png"></a>
                ...
                <div class="nav-links">
                    ...
                    <ul>
                        <li class="nav-link" style="--i: .6s">
                            <a href="<?php echo INCLUDE_PATH; ?>en-US/oquefazernatal">Home</a>
                        </li>

                        <li class="nav-link" style="--i: .6s">
                            <a href="<?php echo INCLUDE_PATH; ?>en-US/oquefazernatal">Natal<i class="fas fa-caret-down"></i></a>
                            ...
                            <div class="dropdown">
                                ...
                                <ul>
                                    <li class="dropdown-link">
                                        <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-natal-">Half Day Tour</a>
                                    </li>
        
                                    <li class="dropdown-link">
                                        <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-natal-">Full Day Tour</a>
                                    </li>

                                    <li class="dropdown-link">
                                        <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-natal-">City of Natal at night</a>
                                    </li>
                                    
                                    <li class="dropdown-link">
                                        <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-natal-">Buggy ride</a>
                                    </li>

                                    <li class="dropdown-link">
                                        <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-natal-">Beaches</a>
                                    </li>

                                    <li class="dropdown-link">
                                        <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-natal-">Tourist attractions</a>
                                    </li>

                                    <li class="dropdown-link">
                                        <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-natal-">Culture</a>
                                    </li>

                                    <li class="dropdown-link">
                                        <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-natal-">services</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="nav-link" style="--i: 1.1s">
                            <a href="<?php echo INCLUDE_PATH; ?>https://checkpointtours.com.br/tours/o-que-fazer-em-natal-">Tours</a>
                        </li>
