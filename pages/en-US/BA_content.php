                ...
                <div class="margin-items">
                    <div class="sideitem" style="background-image: url(<?php echo $infoSite['BA_bg1']; ?>);">
                        <div class="row-content">
                            ...
                            <a href="http://localhost/checkpointtours.com.br/tours/o-que-fazer-em-salvador-" target="_blank">See more >></a>
                    ...
                    <a href="http://localhost/checkpointtours.com.br/tours/o-que-fazer-em-salvador-" class="sideitem-2" style="background-image: url(<?php echo INCLUDE_PATH ?>pages/assets/banners/salvadorbg-eng.png);">
                    </a><!--sideitem-->
    ...
    <?php
		...
		if($categoria['nome'] == 'O que fazer em Salvador '){
			echo '<h2></h2>';
		}else{
			echo '';
		}
        ...
        <div class="double-grid">
            ...
            <div class="grid-main">
                ...
                <section class="section2">
                    <a href="transfers" class="buttonClass">All transfers</a>
                </section>
