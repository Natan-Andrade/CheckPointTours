                ...
                <div class="margin-items">
                    <div class="sideitem" style="background-image: url(<?php echo $infoSite['SP_bg1']; ?>);">
                        <div class="row-content">
                            ...
                            <a href="https://checkpointtours.com.br/tours/o-que-fazer-sao-paulo-tours-de-dia-inteiro-" target="_blank">Ver mais >></a>
                    ...
                    <div class="item_1" style="background-image: url(<?php echo $infoSite['SP_bg2']; ?>);">
                        <div class="row-content">
                            ...
                            <a href="https://checkpointtours.com.br/tours/o-que-fazer-sao-paulo-tours-de-meio-dia" target="_blank">Ver mais >></a>

                        </div><!--row-content-->
                    </div><!--sideitem-->

                    <a href="<?php echo INCLUDE_PATH ?>tours" class="sideitem-2" style="background-image: url(<?php echo INCLUDE_PATH ?>pages/assets/banners/dance\ banner.png);">
                    </a><!--sideitem-->
