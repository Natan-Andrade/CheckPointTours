                ...
                <div class="margin-items">
                    <div class="sideitem" style="background-image: url(<?php echo $infoSite['BA_bg1']; ?>);">
                        <div class="row-content">
                            ...
                            <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-salvador-" target="_blank">Ver mais >></a>
                    ...
                    <a href="https://checkpointtours.com.br/tours/o-que-fazer-em-salvador-" class="sideitem-2" style="background-image: url(<?php echo INCLUDE_PATH ?>pages/assets/banners/salvadorbg.png);">
